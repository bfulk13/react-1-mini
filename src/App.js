  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <input onChange={ (e) => this.handleUpdatePicture(e.target.value) } value={this.state.picture}/>
        <label>Name:</label>
        <input onChange={ (e) => this.handleUpdateName(e.target.value) } value={this.state.name}/>
